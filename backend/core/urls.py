...
from projects.views import  ProjectDetailView, ProjectListCreateView, ProjectUsersView, TaskDetailView, TaskListCreateView, UpdateUserRoleView, CreateRoleView
